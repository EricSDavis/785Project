...
Mel80 *InferCNV* plot shows strong amplifications at chromosome 1,2,3, 7,8,15,19, 20,21,22. It also shows large deletions at chromosome 4,6,9,10,14,19. Most of the data recapitulated the result shown in the paper and are also consistent with the whole exon sequencing data. There is some discrepancy between our data and the plot in the paper regarding copy number variations on chromosome 8 and 22.

Our data showed some amplification on chromosome 22. According to literature, there are some gene loci including the region where EP300 gene is located on chromosome 22 often shows amplification in RAS mutant tumors. Mel 80 has NRAS Q61L mutation. This observation suggests our result could be real. There might be some error during WES or in the analysis of the paper.

We also try to plot heatmap for Mel78 as showed in supplementary materials:

![](./plots/infercnv_plot_78final.png){width=400px}

Mel78 inferCNV plot shows almost identical result as the figure shown in the supplementary part of the paper and is also consistent with the whole exon sequencing data. It shows strong amplification at chromosome 1,2,3,10,11,14,21.

It also shows deletions at chromosome 3,4,5,6,11,12,13,17,18,19, X. The deletion region at the end of chromosome 19 might be assigned to Chromosome 20 in the paper. This might be a labelling mistake.

Comparing the inferCNV plot of Mel 78 and 80, we found they share some common copy number variations. For example, they both have amplification on chromosome 1,2,3,7,19,21,22 and deletions on chromosome 4,5,6, 19, X. The reason might be because they are both RAS mutant tumors.


Overall, we analyzed 6 tumors by inferCNV. As shown below, 5 out of the 6 tumors belong to 3 genomic subtypes of melanoma. The subtype of one tumor (Mel 89) is not identified. We can see clear intertumoral heterogeneity. Each tumor has its own copy number variations. However, we can also see similarities among different tumors, especially the ones of the same subtype. For example, Mel 78 and Mel 80 shared lots of common copy number alterations. By clustering all the 6 tumors together, we can also identify some amplifications and/or deletions common to all of the tumors, suggesting these regions might play a very important role in the progression of melanoma. Further detailed study of these regions could identify potential oncogenes or tumor suppressor genes involved in the development of melanoma.
