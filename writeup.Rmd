...
Copy number variations (CNVs) are genomic alterations, with abnormal deletions or amplifications of one or more gens on segments of chromosomes.
...
Use non-malignant cells as reference cells:

![](./infercnv_plot_80.png){width=400px}


If we do not indicate reference cell, the average signal across all cells will be used to define the baseline:

![](./infercnv_plot_80NULL.png){width=400px}


We also try to plot heatmap for Mel78 as showed in supplementary materials:


![](./infercnv_plot_78final.png){width=400px}
