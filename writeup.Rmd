...
![](project/plots/paper_malignant.png){width=250px}
![](project/plots/paper_nonmalignant.png){width=305px}
...
![](project/plots/malignant_unadj.jpg){width=400px}
![](project/plots/malignant3000.jpg){width=400px}
![](project/plots/malignant300.jpg){width=400px}



![](project/plots/nonmalignant3000_celltype.jpg){width=400px}
![](project/plots/nonmalignant3000_tumor.jpg){width=400px}

![](project/plots/nonmalignant300_celltype.jpg){width=400px}
![](project/plots/nonmalignant300_tumor.jpg){width=400px}

![](project/plots/nonmalignant_unadj_celltype.jpg){width=400px}
![](project/plots/nonmalignant_unadj_tumor.jpg){width=400px}
...
![](project/plots/simlrM300_cluster.jpg){width=400px}
![](project/plots/simlrM300_tumor.jpg){width=400px}

![](project/plots/simlrM300_large_cluster.jpg){width=400px}
![](project/plots/simlrM300_large_tumor.jpg){width=400px}

![](project/plots/simlrN300_large_cluster.jpg){width=400px}
![](project/plots/simlrN300_large_tumor.jpg){width=400px}

![](project/plots/simlrN300_large_celltype.jpg){width=400px}

# Task 2
For the second task, we attempted to replicate the following plot using *inferCNV*.

(insert inferCNV plots)
